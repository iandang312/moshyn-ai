      ...
      <div style={{ display: 'flex', gap: '20px' }}>
        <div>
          <TiltedCard
            ...
            altText="Jeffrey Chao - Co-Founder | Chief Executive Officer"
            captionText="Jeffrey Chao - Co-Founder | Chief Executive Officer"
            ...
            overlayContent={
              (
                <p className="tilted-card-demo-text">
                  Jeffrey Chao - Co-Founder | Chief Executive Officer
                </p>
        ...
        <div>
          <TiltedCard
            ...
            altText="Ian Dang - Co-Founder | Chief Technology Officer"
            captionText="Ian Dang - Co-Founder | Chief Technology Officer"
            containerHeight="250px"
            containerWidth="250px"
            imageHeight="250px"
            imageWidth="250px"
            ...
            overlayContent={
              (
                <p className="tilted-card-demo-text">
                  Ian Dang - Co-Founder | Chief Technology Officer
                </p>
              ) as unknown as undefined
            }
          />
        ...
        <div>
          <TiltedCard
            ...
            altText="Jacob Shin - Co-Founder | Chief Product Officer"
            captionText="Jacob Shin - Co-Founder | Chief Product Officer"
            containerHeight="250px"
            containerWidth="250px"
            imageHeight="250px"
            imageWidth="250px"
            ...
            overlayContent={
              (
                <p className="tilted-card-demo-text">
                  Jacob Shin - Co-Founder | Chief Product Officer
                </p>
              ) as unknown as undefined
            }
          />
